import{j as i}from"./app-a134fab9.js";function c({type:o="button",className:t="",disabled:e,children:n,...s}){return i.jsx("button",{...s,type:o,className:`inline-block cursor-pointer items-center rounded-md border
        ...
        disabled:opacity-25 disabled:active:scale-100 ${e&&"opacity-25"} `+t,disabled:e,children:n})}export{c as S};
