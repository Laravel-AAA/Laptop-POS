import{j as s}from"./app-a6e2ab9e.js";function c({type:o="button",className:n="",disabled:e,children:t,...r}){return s.jsx("button",{...r,type:o,className:`inline-block cursor-pointer items-center rounded-md border
