import{r,j as a}from"./app-a134fab9.js";const u=r.forwardRef(function({type:t="text",className:f="",isFocused:l=!1,...o},s){const i=r.useRef(null);return r.useImperativeHandle(s,()=>({focus:()=>{var e;return(e=i.current)==null?void 0:e.focus()}})),r.useEffect(()=>{var e;l&&((e=i.current)==null||e.focus())},[]),a.jsx("input",{...o,type:t,className:`placeholder:text-slate-400 rounded-md border  border-gray-300 shadow-sm
        ...
        focus:border-primary-600 focus:ring-primary-600 file:active:scale-95
         disabled:opacity-60  `+f,ref:i})});export{u as T};
