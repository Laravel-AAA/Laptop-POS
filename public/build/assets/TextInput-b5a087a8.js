import{r as t,j as c}from"./app-93f448e9.js";const p=t.forwardRef(function({type:l="text",className:f="",isFocused:s=!1,isSelect:o=!1,...a},n){const r=t.useRef(null);return t.useImperativeHandle(n,()=>({focus:()=>{var e;return(e=r.current)==null?void 0:e.focus()},select:()=>{var e;return(e=r.current)==null?void 0:e.select()}})),t.useEffect(()=>{var e,i;s===!0&&((e=r.current)==null||e.focus()),o===!0&&((i=r.current)==null||i.select())},[]),c.jsx("input",{...a,type:l,className:`placeholder:text-slate-400 rounded-md border  border-gray-300 shadow-sm
