import{r,j as a}from"./app-a8cc043f.js";const u=r.forwardRef(function({type:t="text",className:f="",isFocused:l=!1,...o},s){const i=r.useRef(null);return r.useImperativeHandle(s,()=>({focus:()=>{var e;return(e=i.current)==null?void 0:e.focus()}})),r.useEffect(()=>{var e;l&&((e=i.current)==null||e.focus())},[]),a.jsx("input",{...o,type:t,className:`rounded-md border-gray-300 border  shadow-sm placeholder:italic
