...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::patch('/inventory/{id}', [ProductController::class, 'update'])->name('product.update');
    Route::delete('/inventory/{id}', [ProductController::class, 'destroy'])->name('product.destroy');
});
