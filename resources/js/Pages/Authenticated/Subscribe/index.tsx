...
export default function Subscribe({
  ...
  return (
    <>
   <section className="px-6 sm:px-10 md:px-16 xl:hidden block !text-gray-900">
<div className="my-5 flex">
    <FullLogo/>
</div>
            <Link
              href={route("subscription.plans")}
              className="group mb-2 relative inline-flex items-center overflow-hidden rounded-md  px-8 py-2 border border-primary-600 text-md font-medium text-primary-600 hover:bg-gray-50 hover:text-gray-100"
            >

                <span className="duration-400 ease absolute left-0 top-1/2 block h-0 w-full from-primary-600 to-primary-800 bg-gradient-to-r opacity-100 transition-all group-hover:top-0 group-hover:h-full"></span>
      ...
      <div className="flex min-w-0 flex-auto flex-col items-start justify-center sm:flex-row xl:items-center xl:justify-start">
        <div className="relative  hidden h-full flex-auto items-center justify-start overflow-hidden p-10 xl:flex xl:w-2/5">
          ...
          <section className="z-10 -mt-52 w-full max-w-md">
            <Link
              href={route("subscription.plans")}
              className="group mb-2 relative inline-flex items-center overflow-hidden rounded-md  px-8 py-2 border border-secondary-400 text-md font-medium text-secondary-400 hover:bg-secondary-300 hover:text-gray-900"
            >

                <span className="duration-400 ease absolute left-0 top-1/2 block h-0 w-full from-secondary-400 to-secondary-500 bg-gradient-to-r opacity-100 transition-all group-hover:top-0 group-hover:h-full"></span>
                <span className="ease absolute right-0 flex h-10 w-10 translate-x-full transform items-center justify-start duration-300 group-hover:translate-x-0">
                  <svg
                    className="h-5 ml-3 w-5"
                    fill="none"
        ...
        <section className="w-full items-center justify-center flex px-8 md:h-full md:px-10 lg:px-14  xl:w-2/5 ">
