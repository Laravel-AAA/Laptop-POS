  ...
  return (
    <section className="mx-auto w-11/12 md:w-10/12">
      ...
      <P>
        ...
        contains types of information that is collected and recorded by Laptop
        POS and how we use it.
      </P>
      ...
      <P>
        <AppName /> follows a standard procedure of using log files. These files
