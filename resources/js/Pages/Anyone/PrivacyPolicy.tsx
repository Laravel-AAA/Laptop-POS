...
export default function PrivacyPolicy({ auth }: PageProps) {
  ...
  return (
    <>
      ...
      <GuestAuthLayout user={auth.user} header={t("Privacy Policy")}>
        <Content />
      </GuestAuthLayout>
    </>
  );
...
function Content() {
  ...
  return (
    <section className="mx-auto mt-6 w-11/12 space-y-3 md:w-10/12">
      <header>
        <H2>
          {t("Privacy Policy for")} <AppName />
        </H2>

        <P>
          {t("At")} <AppName />,{" "}
          {t(
            "accessible from www.laptop-pos.com, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Laptop POS and how we use it.",
          )}
        </P>
        ...
        <P>
          {t(
            "This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in <AppName />. This policy is not applicable to any information collected offline or via channels other than this website.",
          )}
        </P>
      </header>
      ...
      <section>
        ...
        <P>
          {t(
            "When you register for an Account, we may ask for your contact information, including items such as name, business name, country, city, address, email, and phone number.",
          )}
        </P>
      </section>

      <section>
        <H4>{t("How we use your information")}</H4>
      ...
      <section>
        <H4>{t("Advertising Partners Privacy Policies")}</H4>
      ...
      <section>
        <H4>{t("Third Party Privacy Policies")}</H4>
      ...
      <section>
        <H4>
          {t("CCPA Privacy Rights (Do Not Sell My Personal Information)")}
        </H4>
      ...
      <section>
        <H4>{t("GDPR Data Protection Rights")}</H4>
      ...
      <section>
        <H4>{t("Children's Information")}</H4>
      ...
      <section>
        <H4>{t("Changes to This Privacy Policy")}</H4>
        ...
        <P>
          {t("Our Privacy Policy was created with the help of the")}{" "}
